...
E14 (char * E14_tp, char * E14_p, char * E14_c)
{
  ...
  <D.6331>:
  token.253_8 = token;
  if (token.253_8 == 34) goto <D.6338>; else goto <D.6339>;
  <D.6338>:
  leToken ();
  _9 = E (&E_tp, &E_p, &E_c);
  if (_9 != 0) goto <D.6340>; else goto <D.6341>;
  <D.6340>:
  token.254_10 = token;
  if (token.254_10 == 35) goto <D.6342>; else goto <D.6343>;
  <D.6342>:
  leToken ();
  strcpy (E14_c, &E_c);
  strcpy (E14_p, &E_p);
...
RE ()
{
  ...
  token.255_1 = token;
  if (token.255_1 == 34) goto <D.6347>; else goto <D.6348>;
  <D.6347>:
  leToken ();
  _2 = LP ();
  if (_2 != 0) goto <D.6349>; else goto <D.6350>;
  <D.6349>:
  token.256_3 = token;
  if (token.256_3 == 35) goto <D.6351>; else goto <D.6352>;
  <D.6351>:
  leToken ();
  D.6353 = 1;
  // predicted unlikely by early return (on trees) predictor.
...
main ()
{
  ...
  if (escolha.259_3 < 0) goto <D.6355>; else goto <D.6357>;
  <D.6357>:
  escolha.260_4 = escolha;
  if (escolha.260_4 > 7) goto <D.6355>; else goto <D.6356>;
  <D.6355>:
  __builtin_puts (&"Opcao incorreta, tente novamente ! "[0]);
  system ("pause");
  <D.6356>:
  escolha.261_5 = escolha;
  switch (escolha.261_5) <default: <D.6358>, case 1: <D.5551>, case 2: <D.5553>, case 3: <D.5554>, case 4: <D.5555>, case 5: <D.5556>, case 6: <D.5557>, case 7: <D.5558>>
  <D.5551>:
  ...
  if (escolha.262_6 < 0) goto <D.5559>; else goto <D.6359>;
  <D.6359>:
  escolha.263_7 = escolha;
  if (escolha.263_7 > 7) goto <D.5559>; else goto <D.5560>;
  <D.5560>:
  escolha.264_8 = escolha;
  if (escolha.264_8 != 0) goto <D.5561>; else goto <D.5562>;
  <D.5562>:
  __builtin_puts (&"-- R E S U L T A D O --"[0]);
  codigoFonte = fopen (&arquivo, "r");
  if (codigoFonte == 0B) goto <D.6360>; else goto <D.6361>;
  <D.6360>:
  ...
  if (_10 != 0) goto <D.6362>; else goto <D.6363>;
  <D.6362>:
  goto <D.5563>;
  <D.6363>:
  if (caracter != 9) goto <D.6366>; else goto <D.6364>;
  <D.6366>:
  if (caracter != 10) goto <D.6367>; else goto <D.6364>;
  <D.6367>:
  if (caracter != 13) goto <D.6368>; else goto <D.6364>;
  <D.6368>:
  i.265_11 = i;
  i = i.265_11 + 1;
  ...
  goto <D.6365>;
  <D.6364>:
  if (caracter == 10) goto <D.6369>; else goto <D.6370>;
  <D.6369>:
  i.266_12 = i;
  i = i.266_12 + 1;
  ...
  goto <D.6371>;
  <D.6370>:
  if (caracter == 9) goto <D.6372>; else goto <D.6373>;
  <D.6372>:
  i.267_13 = i;
  i = i.267_13 + 1;
  conteudo[i.267_13] = 9;
  ...
  token = _33;
  token.281_34 = token;
  if (token.281_34 != -1) goto <D.5568>; else goto <D.5570>;
  <D.5570>:
  fclose (codigoFonte);
  posParser = 0;
  posParserLex = 0;
  leToken ();
  _35 = PROGC ();
  if (_35 != 0) goto <D.6374>; else goto <D.6375>;
  <D.6374>:
